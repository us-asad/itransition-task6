...
export default function Home({ messages: msgs }) {
  ...
  return (
    <div className="custom-container flex justify-center items-center min-h-screen py-10">
            ...
            <div className="flex gap-2 items-start">
              <div className="w-full">
                <input
                  type="text"
                  placeholder="John"
                  className={`px-3 py-2 border-2 rounded-md w-full font-medium ${errors.recipient_name ? "border-red-600" : "border-purple-700"}`}
                  {...register("recipient_name", getRegisterValidation(true, 3, 100))}
                />
